...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('item', '0003_remove_item_created_at_remove_item_created_by_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='books', to='item.item')),
